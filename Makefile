...
pkgdatadir = $(datadir)/CrowdFundingCoin
pkgincludedir = $(includedir)/CrowdFundingCoin
pkglibdir = $(libdir)/CrowdFundingCoin
pkglibexecdir = $(libexecdir)/CrowdFundingCoin
...
CONFIG_HEADER = $(top_builddir)/src/config/CrowdFundingCoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/CrowdFundingCoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/lev/Documents/lp/CrowdFundingCoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/lev/Documents/lp/CrowdFundingCoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/lev/Documents/lp/CrowdFundingCoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/lev/Documents/lp/CrowdFundingCoin/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/lev/Documents/lp/CrowdFundingCoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = CrowdFundingCoin
PACKAGE_BUGREPORT = www.CrowdFundingCoin.com
PACKAGE_NAME = CrowdFundingCoin Core
PACKAGE_STRING = CrowdFundingCoin Core 1.0.0
PACKAGE_TARNAME = CrowdFundingCoin
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/lev/Documents/lp/CrowdFundingCoin
abs_srcdir = /home/lev/Documents/lp/CrowdFundingCoin
abs_top_builddir = /home/lev/Documents/lp/CrowdFundingCoin
abs_top_srcdir = /home/lev/Documents/lp/CrowdFundingCoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/lev/Documents/lp/CrowdFundingCoin/build-aux/install-sh
...
pdfdir = ${docdir}
prefix = /home/lev/Documents/lp/CrowdFundingCoin/depends/i686-w64-mingw32
...
SUBDIRS = src
BITCOIND_BIN = $(top_builddir)/src/CrowdFundingCoind$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/CrowdFundingCoin-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/CrowdFundingCoin-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = CrowdFundingCoin-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_CrowdFundingCoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_CrowdFundingCoin_coverage.info test_CrowdFundingCoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/CrowdFundingCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/CrowdFundingCoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/CrowdFundingCoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/CrowdFundingCoin-config.h
$(top_srcdir)/src/config/CrowdFundingCoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/CrowdFundingCoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/CrowdFundingCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/CrowdFundingCoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/CrowdFundingCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_CrowdFundingCoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_CrowdFundingCoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_CrowdFundingCoin_filtered.info: test_CrowdFundingCoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_CrowdFundingCoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_CrowdFundingCoin_coverage.info: baseline_filtered_combined.info test_CrowdFundingCoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_CrowdFundingCoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_CrowdFundingCoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_CrowdFundingCoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_CrowdFundingCoin.coverage/.dirstamp:  test_CrowdFundingCoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_CrowdFundingCoin.coverage/.dirstamp total.coverage/.dirstamp

# CrowdFundingCoin: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_CrowdFundingCoin.coverage/ total.coverage/ $(OSX_APP)
