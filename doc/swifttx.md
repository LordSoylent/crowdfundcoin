...
This mechanism has been integrated into Bitcore-Node-CrowdFundingCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CrowdFundingCoin-Project/insight-api-CrowdFundingCoin#web-socket-api](https://github.com/CrowdFundingCoin-Project/insight-api-CrowdFundingCoin#web-socket-api) 
* API: [https://github.com/CrowdFundingCoin-Project/insight-api-CrowdFundingCoin#swifttx-transactions](https://github.com/CrowdFundingCoin-Project/insight-api-CrowdFundingCoin#swifttx-transactions) 
...
By default, the CrowdFundingCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CrowdFundingCoin Core daemon:
