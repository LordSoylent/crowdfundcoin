...
In order to support loading of multiple wallets in CrowdFundingCoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is CrowdFundingCoin.cpp.
...
Changes to CrowdFundingCoin.cpp
----------------------
CrowdFundingCoin.cpp is the entry point into CrowdFundingCoin-qt, and as such, will require some minor modifications to provide hooks for
