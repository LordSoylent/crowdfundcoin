...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CrowdFundingCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CrowdFundingCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CrowdFundingCoin features */
        {"CrowdFundingCoin", "masternode", &masternode, true, true, false},
        {"CrowdFundingCoin", "listmasternodes", &listmasternodes, true, true, false},
        {"CrowdFundingCoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"CrowdFundingCoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"CrowdFundingCoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"CrowdFundingCoin", "masternodedebug", &masternodedebug, true, true, false},
        {"CrowdFundingCoin", "startmasternode", &startmasternode, true, true, false},
        {"CrowdFundingCoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"CrowdFundingCoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"CrowdFundingCoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"CrowdFundingCoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"CrowdFundingCoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"CrowdFundingCoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"CrowdFundingCoin", "mnbudget", &mnbudget, true, true, false},
        {"CrowdFundingCoin", "preparebudget", &preparebudget, true, true, false},
        {"CrowdFundingCoin", "submitbudget", &submitbudget, true, true, false},
        {"CrowdFundingCoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"CrowdFundingCoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"CrowdFundingCoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"CrowdFundingCoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"CrowdFundingCoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"CrowdFundingCoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"CrowdFundingCoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"CrowdFundingCoin", "checkbudgets", &checkbudgets, true, true, false},
        {"CrowdFundingCoin", "mnsync", &mnsync, true, true, false},
        {"CrowdFundingCoin", "spork", &spork, true, true, false},
        {"CrowdFundingCoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"CrowdFundingCoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use CrowdFundingCoind, or the -server option to CrowdFundingCoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> CrowdFundingCoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:47756/\n";
}
