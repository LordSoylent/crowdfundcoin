...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CrowdFundingCoin Core"),
     ...
     * override -datadir in the CrowdFundingCoin.conf file in the default data directory
     * (to be consistent with CrowdFundingCoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
