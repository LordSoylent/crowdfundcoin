...
/** Utility functions used by the CrowdFundingCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CrowdFundingCoin addresses in monospace font
...
// Parse "CrowdFundingCoin:" URI into recipient object, return true on successful parsing
