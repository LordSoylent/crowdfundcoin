                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CrowdFundingCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CrowdFundingCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and CrowdFundingCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CrowdFundingCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CrowdFundingCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CrowdFundingCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CrowdFundingCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CrowdFundingCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a CrowdFundingCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CrowdFundingCoin Core help message to get a list with possible CrowdFundingCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CrowdFundingCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CrowdFundingCoin network", "", count));
}
...
{
    QString strTitle = tr("CrowdFundingCoin Core"); // default title
    ...
    // Append title to "CrowdFundingCoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
