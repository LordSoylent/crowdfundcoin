/* src/config/CrowdFundingCoin-config.h.  Generated from CrowdFundingCoin-config.h.in by configure.  */
/* src/config/CrowdFundingCoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CFUND_CONFIG_H

#define CFUND_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.CrowdFundingCoin.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CrowdFundingCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CrowdFundingCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "CrowdFundingCoin"
