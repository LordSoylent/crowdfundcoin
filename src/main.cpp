...
#if defined(NDEBUG)
#error "CrowdFundingCoin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        else if (nHeight >= 300 && nHeight < 40000) {
        nSubsidy = 6 * COIN;
    }
        ...
        else if (nHeight >= 500000 && nHeight < 7500000) {
        nSubsidy = 5 * COIN;
    }
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
  ...
  if (nHeight > 300 && nHeight < 140000) { ret = blockValue * 0.8;
    } else if (nHeight >= 140000) { ret = blockValue * 0.85;
    }
...
{
    RenameThread("CrowdFundingCoin-scriptch");
