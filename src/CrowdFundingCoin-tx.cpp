...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CrowdFundingCoin Core CrowdFundingCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  CrowdFundingCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded CrowdFundingCoin transaction") + "\n" +
                               "  CrowdFundingCoin-tx [options] -create [commands]   " + _("Create hex-encoded CrowdFundingCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded CrowdFundingCoin transaction
